...
\p{An Analytical Study and Analysis of Filtering Techniques}
\ \ \ \ \ \  used for Classification of Recommender Systems
\ \ - Bachelor dissertation; CSE, SEST, Jamia Hamdard.
\ \ - Presented on Sept. 23, 2020.

\p{A Review on Filtering Techniques Used for}
\ \ \ \ \ \ Classification of Recommender Systems
\ \ - \doi{10.2139/ssrn.3563557}{Elsevier SSRN}
\ \ - Presented at ICICC-2020 on Feb 22, 2020.

\p{Reader: Speech Synthesizer and Speech Recognizer}
\ \ - \doi{10.1007/978-981-15-5148-2\_76}{Springer AISC}
\ \ - Presented at ICICC-2020 on Feb 22, 2020.
...
\project{headless-mermaid}{2020}{}\gitlink{muhammadmuzzammil1998/headless-mermaid} \lang{JavaScript (Node.js)}
\p{A mermaid.js handler for server-side rendering.}
